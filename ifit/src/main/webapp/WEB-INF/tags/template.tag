...
<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-md-7 py-4">
						...
						<p class="text-muted">Somos estudantes do 3º período do curso
							de Sistemas para Internet do Instituto Federal do Triângulo
							Mineiro - Campus Uberlândia Centro.</p>
						<p class="text-muted">O time UAIGYM é composto pelos alunos: Gledson Junior, Kelvin
						Arruda, Nawan Soares, Pedro Paulo e Wanderson Gutemberg.
						</p>
					</div>
	...
	<footer id="myFooter">
		<div class="container">
			<div class="row">
				<div class="col-sm-12 text-center p-4">&copy; UaiGym 2020 -
