...
public class EmailSender {
	...
	try {
	    ...
	    System.out.println("O remetente " + email.getSender() + " enviou para " + email.getReceiver()
		    + " um email de " + resumoLog);
	    return true;

	} catch (MessagingException e) {
	    System.out.println("N�o foi poss�vel enviar o email " + resumoLog + " de " + email.getSender()
		    + " para " + email.getReceiver());
	    e.printStackTrace();
	    return false;
	}
